...
class Help(commands.Cog):   
    ...
    async def helps(self, ctx):
        ...
        embed_message4.add_field(name="warn", value="Avertir un membre =warn [@user] [raison] [nombre] (messages perms only) ex: =warn @user Spam 3 - Les warns sont par serveur")
        embed_message4.add_field(name="resetwarn, warnreset", value="Reset les warns d'un membre =resetwarn [@user] (messages perms only) - Les warns sont par serveur")
        embed_message4.add_field(name="warnboard, warnleaderboard, warnlb", value="Affiche le leaderboard des warns =warnboard - Affiche les warns du serveur actuel")
        ...
        embed_message4.add_field(name="banword, addbannedword", value="Ajoute un mot à la liste des mots bannis =banword [mot] (messages perms only) - Les mots bannis sont par serveur")
        embed_message4.add_field(name="unbanword, removebannedword", value="Retire un mot de la liste des mots bannis =unbanword [mot] (messages perms only) - Les mots bannis sont par serveur")
        embed_message4.add_field(name="listbannedwords, bannedwords, bwlist", value="Affiche la liste des mots bannis =listbannedwords (messages perms only) - Affiche les mots bannis du serveur actuel")
        embed_message4.add_field(name="📌 Système par serveur", value="Les warns et les mots bannis sont **indépendants par serveur**. Chaque serveur a sa propre liste de mots bannis et ses propres warns.", inline=False)
